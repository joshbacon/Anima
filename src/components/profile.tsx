...
function Profile() {
    ...
    const { snapToGrid, color, profileData } = useSelector((state: RootState) => state.settings);
    ...
    return <div
        ...
        className={profileData.showing ? `flex flex-col gap-4 p-3 bg-${color}-600 bg-opacity-50 hover:bg-opacity-70 rounded-2xl overflow-y-scroll transition-all duration-700` : 'hidden'}
    >
